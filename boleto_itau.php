...
$textoendereco1 = $logradouro . ", ". $numcasa;
$textoendereco2 = $localidade . " - CEP: " . $cep;
$dadosboleto["sacado"] = $nome;
$dadosboleto["endereco1"] = iconv("ISO-8859-1", "UTF-8", $textoendereco1);
$dadosboleto["endereco2"] = iconv("ISO-8859-1", "UTF-8", $textoendereco2);

// INFORMACOES PARA O CLIENTE
$dadosboleto["demonstrativo1"] = "Pagamento referente a doação do jogo SPACE <br>Taxa bancária - R$ ".number_format($taxa_boleto, 2, ',', '');
$dadosboleto["demonstrativo2"] =  "PESADOWN Software - http://www.pesadown.com.br";
$dadosboleto["demonstrativo3"] = "";
$dadosboleto["instrucoes1"] = "- Sr. Caixa, cobrar multa de 2% após o vencimento";
$dadosboleto["instrucoes2"] = "- Receber até 10 dias após o vencimento";
$dadosboleto["instrucoes3"] = "- Em caso de dúvidas entre em contato conosco: pesadownsoft@hotmail.com";
